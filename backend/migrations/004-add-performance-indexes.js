...
async function addPerformanceIndexes(sequelize) {
    ...
    try {
        ...
        try {
            ...
            console.log('  ℹ️  idx_coach_athlete_status_lookup may already exist');
        }
        ...
        try {
            ...
            console.log('  ℹ️  idx_coach_athlete_pending may already exist');
        }
        ...
        try {
            ...
            console.log('  ℹ️  idx_coach_active_athletes may already exist');
        }
